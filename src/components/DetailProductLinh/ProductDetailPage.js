...
const ProductDetailPage = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`${API_DOMAIN}/api/product/${id}`);
    ...
    const handleClickBuy = async () => {
        try {
            ...
            const response = await axios.post(`${API_DOMAIN}/api/user/addCartItem`, data, {
                headers: {
            ...
            <div className="max-w-[1200px] mx-auto">
                <div>
                    ...
                    <div className="flex my-5">
                        ...
                        <div className="basis-2/5 p-10">
                            <h3 className="text-gray-700 font-bold text-4xl py-2">
                                {product.name}
                            </h3>
                            ...
                            <p className="text-gray-700 font-bold text-xl py-2">
                                ...
                                <span className="font-normal">
                                    24 tháng kể từ ngày sản xuất, bảo quản nơi khô ráo thoáng mát
                                </span>
                            </p>
                            <p className="text-red-400 text-xl font-semibold py-3">
                        ...
                        <div className="basis-1/5">
                            <img
                                src={advise}
                                alt="Tư vấn đặt hàng"
                                className="flex-1 w-full h-auto rounded-md cursor-pointer"
                            />
                        </div>
                    </div>
                ...
                <div className="mb-10">
                    ...
                    {moreProducts.length === 0 ? (
                        ...
                        <ProductList products={moreProducts} productsPerPage={productsPerPage} />
                    )}
                </div>
                <ConsBages />
            </div>
