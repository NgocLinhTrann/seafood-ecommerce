import '../main.css';
import CompanyLogo from '../assets/images/logo_seafood.png'
import { VscHeart, VscAccount, VscMenu } from "react-icons/vsc";
            ...
            <nav className="relative bg-cyan-500">
                <div className="mx-auto hidden h-12 w-full max-w-[1200px] items-center md:flex">
                    {/* <button className="ml-5 flex h-full w-40 cursor-pointer items-center justify-center bg-amber-400">
                        <div className="flex justify-around items-center" href="#">
                            <VscMenu className='mr-1.5'/>
                            All categories
                        </div>
                    </button> */}
