        ...
        <div className="flex justify-center mt-2">
            ...
            <div className="relative mr-48">
                ...
                <div className="absolute top-1/2 left-1/2 mx-auto flex w-11/12 max-w-[1200px] -translate-x-1/2 -translate-y-1/2 flex-col text-center text-white lg:ml-5">
                    ...
                    <button className="mx-auto mt-5 w-1/2 bg-amber-400 px-3 py-1 text-ưhite duration-100 hover:bg-yellow-300 bold lg:mx-0 lg:h-10 lg:w-2/12 lg:px-10 rounded-md">
                        Mua ngay
                    </button>
                </div>
            </div>
