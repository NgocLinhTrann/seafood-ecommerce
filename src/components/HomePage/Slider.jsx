            ...
            <>
                ...
                <div className="absolute top-1/2 left-1/2 mx-auto flex w-11/12 max-w-[1200px] -translate-x-1/2 -translate-y-1/2 flex-col text-center text-white lg:ml-5">
                    ...
                    <p className="pt-3 text-xs lg:w-3/5 lg:pt-5 lg:text-left lg:text-base">
                        Chúng tôi nỗ lực mỗi ngày để cung cấp đến tay khách hàng những sản phẩm ngon nhất, sạch nhất và dịch vụ khách hàng tốt nhất.
                    </p>
                    <button className="mx-auto mt-5 w-1/2 bg-amber-400 px-3 py-1 text-white duration-100 hover:bg-yellow-300 bold lg:mx-0 lg:h-10 lg:w-2/12 lg:px-10 rounded-md">
                        Mua ngay
                    </button>
                </div>
            </>
