...
const AddDiscount = () => {
    ...
    return (
        <Layout title="Thêm khuyến mãi" activePage="discount add">
            <Toaster />
                ...
                <form className="mt-2 w-full flex-grow mb-10 px-5">
                    <div className="container border px-5 py-5 shadow-sm">
                        <div className="flex justify-center">
                            <div className="text-3xl font-bold">THÊM KHUYẾN MÃI</div>
                        </div>

                        <label className="label mt-3 font-medium">Mã khách hàng</label>
                        <input
                            className="input"
                            value={userId}
                            onChange={(e) => setUserId(e.target.value)}
                        ></input>
                        <label className="label mt-3 font-medium">Mã Khuyến mãi</label>
                        <input
                            className="input"
                            value={code}
                        ...
                        <div className="flex gap-10">
                            ...
                            <div className="field">
                                <label className="label mt-3 font-medium">Số lượng mã</label>
                                <input
                                    type="text"
                                    className="input"
                                    value={available}
