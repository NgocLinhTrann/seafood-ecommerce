                ...
                <ul className="perfect-scrollbar relative space-y-0.5 h-[calc(100vh-80px)] p-4 py-0 font-semibold">
                    <li className="menu nav-item space-y-0\.5>:not([hidden])~:not([hidden])">
                        <NavLink
                            ...
                            className={`nav-link group mb-1 flex w-full justify-between overflow-hidden whitespace-nowrap rounded-md p-2.5 items-center ${
                                activePage === 'dashboard' ? 'bg-cyan-500 text-white' : ''
                            }`}
                        >
                    ...
                    <li className="menu nav-item space-y-0\.5>:not([hidden])~:not([hidden])">
                        <NavLink
                            ...
                            className={`nav-link group mb-1 flex w-full justify-between overflow-hidden whitespace-nowrap rounded-md p-2.5 items-center ${
                                activePage === 'product' ? 'bg-cyan-500 text-white' : ''
                            }`}
                        >
                            <div class="flex items-center">
                                <GoTasklist size={23} />
                    ...
                    <li className="menu nav-item space-y-0\.5>:not([hidden])~:not([hidden])">
                        <NavLink
                            to="/admin/manage-product"
                            className={`nav-link group mb-1 flex w-full justify-between overflow-hidden whitespace-nowrap rounded-md p-2.5 items-center ${
                                activePage === 'product' ? 'text-cyan-500' : ''
                            }`}
                        >
                            <div class="flex items-center">
                    ...
                    <li className="menu nav-item space-y-0\.5>:not([hidden])~:not([hidden])">
                        <NavLink
                            ...
                            className={`nav-link group mb-1 flex w-full justify-between overflow-hidden whitespace-nowrap rounded-md p-2.5 items-center ${
                                activePage === 'product add' ? 'text-cyan-500' : ''
                            }`}
                        >
                            <div class="flex items-center">
                                <IoIosArrowRoundForward />
                    ...
                    <li className="menu nav-item space-y-0\.5>:not([hidden])~:not([hidden])">
                        <NavLink
                            ...
                            className={`nav-link group mb-1 flex w-full justify-between overflow-hidden whitespace-nowrap rounded-md p-2.5 items-center ${
                                activePage === 'order' ? 'bg-cyan-500 text-white' : ''
                            }`}
                        >
                            <div class="flex items-center">
                                <GoPackage size={21} />
                    ...
                    <li className="menu nav-item space-y-0\.5>:not([hidden])~:not([hidden])">
                        <NavLink
                            ...
                            className={`nav-link group mb-1 flex w-full justify-between overflow-hidden whitespace-nowrap rounded-md p-2.5 items-center ${
                                activePage === 'discount' ? 'bg-cyan-500 text-white' : ''
                            }`}
                        >
                            <div class="flex items-center">
                                <TbDiscount2 size={21} />
                    ...
                    <li className="menu nav-item space-y-0\.5>:not([hidden])~:not([hidden])">
                        <NavLink
                            to="/admin/manage-discount"
                            className={`nav-link group mb-1 flex w-full justify-between overflow-hidden whitespace-nowrap rounded-md p-2.5 items-center ${
                                activePage === 'discount' ? 'text-cyan-500' : ''
                            }`}
                        >
                            <div class="flex items-center">
                                <IoIosArrowRoundForward />
                                <span class="pl-3 font-normal">Danh sách khuyến mãi</span>
                            </div>
                        </NavLink>
                    </li>
                    <li className="menu nav-item space-y-0\.5>:not([hidden])~:not([hidden])">
                        <NavLink
                            ...
                            className={`nav-link group mb-1 flex w-full justify-between overflow-hidden whitespace-nowrap rounded-md p-2.5 items-center ${
                                activePage === 'discount add' ? 'text-cyan-500' : ''
                            }`}
                        >
                            <div class="flex items-center">
                                <IoIosArrowRoundForward />
                                <span class="pl-3 font-normal">Thêm khuyến mãi</span>
                            </div>
                        </NavLink>
                    </li>
                    <li className="menu nav-item space-y-0\.5>:not([hidden])~:not([hidden])">
                        <NavLink
                            ...
                            className={`nav-link group mb-1 flex w-full justify-between overflow-hidden whitespace-nowrap rounded-md p-2.5 items-center ${
                                activePage === 'customer' ? 'bg-cyan-500 text-white' : ''
                            }`}
                        >
                            <div class="flex items-center">
                                <GoPeople size={19} />
                    ...
                    <li className="menu nav-item space-y-0\.5>:not([hidden])~:not([hidden])">
                        <NavLink
                            to="/login"
                            className={`nav-link group mb-1 flex w-full justify-between overflow-hidden whitespace-nowrap rounded-md p-2.5 items-center ${
                                activePage === 'logout' ? 'bg-cyan-500 text-white' : ''
                            }`}
                        >
                            <div class="flex items-center">
                                <GoSignOut size={20} />
