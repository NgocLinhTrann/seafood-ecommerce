...
function SignUpPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!v1 || !v2) {
      setErrMsg(
        "Gmail hoặc mật khẩu không đúng. Xin hãy nhập lại!"
      );
      return;
    }
    ...
    axios
      .post(
        "https://seafoodharbor.azurewebsites.net/api/user/register",
        {
          fullname: name,
          email: email,
          password: pwd,
      ...
      .catch((err) => {
        if (!err?.response) {
          setErrMsg(
            "Hệ thống không phản hồi! Xin đợi và thử lại trong giây lát."
          );
        } else if (err.response?.status === 400) {
          setErrMsg(
            "Tài khoản gmail này đã được đăng ký!!!"
          );
  ...
  const changeCity = (event) => {
    ...
    setProvinces(
      hcm.find((city) => city.name === event.target.value)
        .states
    );
  };
                  ...
                  <div className="field">
                    ...
                    <div className="control">
                      ...
                      >
                        ...
                        <br />
                        Chữ, số, gạch dưới, gạch nối được
                        cho phép.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="field">
                    ...
                    <div className="control">
                      ...
                      >
                        ...
                        Phải có chữ in hoa, chữ thường, số
                        và ký tự đặc biệt.
                        <br />
                        Các ký tự đặc biệt được cho phép:{" "}
                        <span aria-label="exclaimtion-mark">
                          !
                        </span>
                    ...
                    <div className="control">
                      ...
                      >
                        <FontAwesomeIcon
                          icon={faInfoCircle}
                        />
                        &nbsp; Trường này phải trùng với
                        trường nhập mật khẩu
                      </p>
                    </div>
                  </div>
                  <button
