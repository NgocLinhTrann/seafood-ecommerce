...
function ForgetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    axios
      .post(
        "https://seafoodharbor.azurewebsites.net/api/resetpass/checkMail",
        {
          email: email,
        }
      )
      ...
      .catch((err) => {
        if (!err?.response) {
          ...
          setErrMsg(
            "Tài khoản email không tồn tại! Vui lòng kiểm tra lại!"
          );
        }
  ...
  const handleOtp = async (e) => {
    ...
    await axios
      .post(
        "https://seafoodharbor.azurewebsites.net/api/resetpass/checkResetCode",
        {
          email: email,
          resetcode: otp,
        }
  ...
  useEffect(() => {
    console.log(resp);
    resp
      ? setIdOfResetCode(resp.idOfResetCode)
      : console.log("");
