...
//                                         </div>
//                                     </td>
//                                     <td className="mx-auto text-center" style={{ verticalAlign: 'middle' }}>{formatPrice(320000)}</td>
//                                     <td className="align-middle">
...
//                                         </div>
//                                     </td>
//                                     <td className="mx-auto text-center" style={{ verticalAlign: 'middle' }}>{formatPrice(520000)}</td>
//                                     <td className="align-middle">
