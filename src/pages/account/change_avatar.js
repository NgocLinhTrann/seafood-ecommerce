...
function ChangeAvatar() {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const response = await axios.put(`${API_DOMAIN}/api/user/changeAvatar`, formData, {
                headers: {
                        ...
                        <div className="mb-6 px-2 grow-0 shrink-0 w-3/4 relative p-0 box-border block text-left colright">
                            ...
                            >
                                ...
                                <div className="box-info-account py-4 px-6 box-border block">
                                    <div
                                        className="form-update max-w-xl m-0 p-0 block box-border font-medium"
